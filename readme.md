...
# Before running, read about Environmental Variables below
vercel dev
```
...
**First time local development server setup**<br/>
...
```
? Set up and develop “~\...\...\JeepLink_App”? yes
# (or just type 'y', and press enter)

? Which scope should contain your project? <your_name>'s projects
# (or just press enter)

? Link to existing project? no
# (or just type 'n', and press enter)

? What’s your project’s name? jeep-link-app
# (or just press enter)
...
Remember to import the `.env.local` file to your Vercel project's environment variables by going through your project > settings > Environmental Variables.
