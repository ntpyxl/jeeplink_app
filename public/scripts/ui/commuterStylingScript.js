$(document).ready(function () {
    ...
    window.renderRoutes = function (routeData) {
        ...
        routes.forEach(route => {
            ...
            const html = `
            <div class="min-w-full px-2 md:px-1">

                <div class="bg-gradient-to-br from-[#004F11] to-[#1f7a3a]
                            rounded-2xl shadow-lg overflow-hidden border border-white/10">

                    <div class="route-details">

                        <!-- HEADER -->
                        <div class="summary flex items-center justify-between gap-3 
                                    px-4 py-4 cursor-pointer select-none">

                            <div class="flex items-center gap-3 flex-1">

                                <div class="w-10 h-10 rounded-full bg-[#E9CD2D]
                                            flex items-center justify-center">
                                    <i class="fa-solid fa-route text-[#004F11]"></i>
                                </div>

                                <div class="flex flex-col">
                                    <span class="text-[#E9CD2D] font-semibold">
                                        ${route.title}
                                    </span>
                            ...
                            <span class="text-[#E9CD2D] transition-transform duration-300 arrow">
                                ▼
                            </span>
                        ...
                        <!-- CONTENT -->
                        <div class="route-content hidden bg-white/95 text-gray-800 px-4 py-3">
